...
#dataset_name = 'flux_only_data_frac_07_widerange_all.csv'
dataset_size = 20 # test/train and  validate size
runtime = 60*20 # in seconds
# Batch
batch_boolean = True
...
def runModel(x_train, x_test, y_train, y_test, x_validate, y_validate, func_name, directory,feature_columns,target_column,runtime):
    ...
    model = PySRRegressor(
        ...
        maxsize=25,  # Maximum size of the equations
...
if batch_boolean:
    ...
    base_directory = "C:/Users/brand/Documents/Python Scripts/pysr_code/datasets/Nguyen-RBFs-n-ns-(1,3,40)"
