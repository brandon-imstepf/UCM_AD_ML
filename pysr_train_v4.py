...
Need to:
    ...
    - Implement holdout validation dataset comparison
    - Implement elbow curve (and compare with best chosen)
    - Implement data visualization
    - Use different transformation of data (standard normal transformation)
'''
...
def runModel(x, y, func_name, directory, stop_count=5):
    ...
    model = PySRRegressor(
        ...
        timeout_in_seconds=60*3,  # Timeout in seconds
    ...
    plot_residual_kde(train_datalog_primary, output_dir=training_dir)
    # NEED TO FIX THE SCATTEER FUNCTIONS TO WORK MORE DYNAMICALLY!
    #scatter_residuals_vs_true(train_datalog_primary, output_dir=training_dir)
    ...
    plot_residual_kde(test_datalog_primary, output_dir=testing_dir)
    #scatter_residuals_vs_true(test_datalog_primary, output_dir=testing_dir)
    ...
    plot_residual_kde(validation_datalog_primary, output_dir=validation_dir)
    #scatter_residuals_vs_true(validation_datalog_primary, output_dir=validation_dir)
...
def process_large_dataset(base_directory, dataset):
    '''
    Input:
...
base_directory = 'C:/Users/brand/Desktop/Raj-Sindi/training_data/sim_csv_v6/12-6/train'
