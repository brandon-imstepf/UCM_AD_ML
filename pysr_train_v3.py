...
from stat_plots import scale_data_YeoJohnson
...
def runModel(x, y, func_name, directory, stop_count=5):
    ...
    # Pratham says data less than 1e-6 will run into issues
    x, y = scale_data_YeoJohnson(x, y)
    ...
    model = PySRRegressor(
        ...
        timeout_in_seconds=60*60,  # Timeout in seconds
        ...
        unary_operators=["sin","cos"],  # Unary operators to be used
        #nested_constraints={
